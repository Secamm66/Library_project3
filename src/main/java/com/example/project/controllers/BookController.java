...
public class BookController {
    ...
    @PostMapping("/search")
    public String makeSearch(@RequestParam(value = "searching_books", required = false) String searchingBooks, Model model) {
        model.addAttribute("books", booksService.findByTitleStartingWith(searchingBooks));
        return "books/search";
    }

    @ModelAttribute("person_details")
    public PersonAccount getPersonDetails() {
